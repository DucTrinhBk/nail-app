...
class _String {
  ...
  String checkin_title = 'checkin_title'.tr;
  String checkout_title = 'checkout_title'.tr;
  String login_notify = 'login_notify'.tr;
  String account = 'account'.tr;
  String password = 'password'.tr;
  String login = 'login'.tr;
  String first_name = 'first_name'.tr;
  String last_name = 'last_name'.tr;
  String email = 'email'.tr;
  String option = 'option'.tr;
  String dob = 'dob'.tr;
}